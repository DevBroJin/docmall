                  ...
                  <tbody>
                    ...
                    <c:forEach items="${pro_list }" var="productVO">
                      <tr>
                        ...
                        <td>
                          <a class="move" href="#" data-bno="${productVO.pro_num}">
                            <img src="imageDisplay?dateFolderName=${productVO.pro_up_folder}&fileName=s_${productVO.pro_img}">
                          </a>
                        ...
                        <td>
                          <select id="pro_buy" name="pro_buy">
                            ...
                            <option value="N" ${productVO.pro_buy=='Y' ? 'selected' :''}>판매불가</option>
                          </select>
                        </td>
              ...
              <div class="box-footer clearfix">
                <div class="row">
                  ...
                  <div class="col-md-2 text-right">
                    <button type="button" class="btn btn-primary" role="button">상품등록</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    $(document).ready(function () {
      ...
      $("#btn_check_modify").on("click", function () {
        ...
        $("input[name='check']:checked").each(function() {
          ...
          pro_buy_arr.push($this.parent().parent().find("input=[name='pro_buy']").val());
        });
