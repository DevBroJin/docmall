    			...
    			<div class="box box-primary">
					...
					<form role="form" method="post" action="/admin/product/pro_edit" enctype="multipart/form-data">
			              ...
			              <div class="col-sm-3">
			                <select class="form-control" id="secondCategory" name="cg_code">
			                  ...
			                  <c:forEach items="${second_CategoryList }" var="categoryVO">
			                  	<option value="${categoryVO.cg_code }"  ${categoryVO.cg_code == productVO.code? 'selected':'' }>${categoryVO.cg_name }</option>
			                  </c:forEach>
			                </select>
			              </div>
						</div>
						<div class="form-group row">
			              ...
			              <div class="col-sm-4">
			              	<input type="hidden" class="form-control" name="pro_num" id="pro_num" value="${productVO.pro_num }">
