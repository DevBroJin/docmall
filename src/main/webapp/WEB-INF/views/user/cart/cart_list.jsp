			...
			<tbody>
			 <c:forEach items="${cart_list }" var="CartDTO">
			  <tr>
				...
				<td><input type="number" name="cart_amount" value="${CartDTO.cart_amount }" style="width: 35px;">
					<button type="button" name="btn_cart_amount_change" class="btn btn-danger">변경</button></td>
